...
((e) => {
  ...
  const n = (e) => {
    ...
    try {
      const r =
        (t = e == null ? void 0 : e.constructor) === null || void 0 === t
          ? void 0
          : t.name;
      if (r) return r;
    } catch (e) {}
    try {
      const t =
        (n =
          null ===
            (r = e == null ? void 0 : e.__zone_symbol__originalInstance) ||
          void 0 === r ?
                void 0 :
                r.constructor) ===
            null || void 0 === n ?
  ...
  const o = (e) => (e.nodeType === 11 && e.host ? "#s" : e.nodeName);
  const a = () =>
  ...
  const y = (e, t, r, n, s) => {
    if ((r = m[e]) && r.U) {
      if (e === t) return r.U;
      if (((n = r.U.document), (s = t.split(".").pop()) === "d")) return n;
      if (s === "e") return n.documentElement;
      if (s === "h") return n.head;
      if (s === "b") return n.body;
    }
    return d.get(t);
  };
  const v = (e, t, r) => {
  ...
  const C = (e, t, r, i, a) =>
    void 0 !== t && (i = typeof t)
      ? i === "string" || i === "number" || i === "boolean" || t == null ?
        [0, t]
        : "function" === i
        ? [6]
        ...
        : void 0
      : t;
  const I = (e, t, r, s, o, a, l, c) => {
    if (((a = {}), !r.has(t)))
      for (l in (r.add(t), t))
        i(l) &&
          ((c =
            l === "path" && n(t).endsWith("Event") ? t.composedPath() : t[l]),
          (s || typeof c !== "function") &&
            (o || c !== "") &&
            (a[l] = C(e, c, r)));
    return a;
  ...
  const N = (t) => t instanceof e.top.Error;
  const x = (t, r, n, s) =>
    r
      ? ((n = r[0]),
        (s = r[1]),
  ...
  const R = (e) => new ("detail" in e ? CustomEvent : Event)(e.type, e);
  const A = (e, t, r, n) => {
      ...
      try {
        if (!Array.isArray(l))
          if (typeof c === "string" || typeof c === "number") {
            if (p + 1 === m && a)
              return (d = {}), a.map((e) => (d[e] = s[e])), d;
            s = s[c];
          } else {
            if (l === 0) return void (s[u] = x(e, c));
            if (
              typeof s[u] === "function" &&
              ((h = x(e, c)),
              u === "define" &&
                n(s) === "CustomElementRegistry" &&
                (h[1] = T(t, e, h[1])),
              u === "insertRule" &&
                h[1] > r(s.cssRules) &&
                (h[1] = r(s.cssRules)),
  ...
  const O = (e, t, r) => {
    if (!g.has(r)) {
      ...
      const u = s.pushState.bind(s);
      const h = s.replaceState.bind(s);
      const d = (r, s, i, o) => () => {
        setTimeout(() => {
          e.postMessage([
            13,
      ...
      (s.pushState = (e, t, r) => {
        u(e, t, r), l(d(0, e, r == null ? void 0 : r.toString()));
      }),
        (s.replaceState = (e, t, r) => {
          h(e, t, r), l(d(1, e, r == null ? void 0 : r.toString()));
        }),
        ...
        (m[t] = { V: t, U: r }),
        n.readyState === "complete" ? c() : r.addEventListener("load", c);
    }
  };
  const k = () => {
  ...
  const D = (e, t, r, s, i, a) => {
    if (!e.has(r)) {
      ...
      const c = n(l);
      const u = [];
      const h = Object.getOwnPropertyDescriptors(s);
      D(e, t, c, l, i, a);
  ...
  const W = (e, t, r, s, o, a) => {
    try {
      i(r) &&
        isNaN(r[0]) &&
        r !== "all" &&
        ((o = typeof (s = t[r])) == "function" ?
          (String(s).includes("[native") || Object.getPrototypeOf(t)[r]) &&
            e.push([r, 5])
          : o === "object" && s != null ?
          (a = n(s)) !== "Object" && self[a] && e.push([r, s.nodeType || a])
          : o !== "symbol" &&
  ...
  const J = (e, r) => (void 0 !== e[r] ? new e[r](t) : 0);
  let q;
  (async (e) => {
    ...
    return (n, s) => {
      ...
      if (i === 0) {
        const e = (() => {
          ...
          const r = S.createComment("");
          const n = S.createDocumentFragment();
          const s = S.createElement("p").attachShadow({ mode: "open" });
          const i = J($, "IntersectionObserver");
          const o = J($, "MutationObserver");
          const a = J($, "ResizeObserver");
          const l = $.performance;
          const c = $.screen;
          const u = [
            [$.history],
