...
((e) => {
  ...
  const l = Symbol();
  const m = [];
  const v = (e, t, s) => (e[t] = S(t, s));
  const S = (e, t) => Object.defineProperty(t, "name", { value: e });
  const b = (e, t) => {
    const r = {
      getContext: {
        value(e, t) {
    ...
    const p = (e, t, r) => {
      const i = e[o];
            const c = a();
            const f = { [o]: i, [d]: c, [u]: [] };
            const p = n(e, ["getContext"], [t, r], 1, c);
            const g =
            ...
            "string" === typeof t && t in p ?
                  "function" === typeof p[t] ?
                    ...
                    if (t.startsWith("create")) {
                      ...
                      return (
                        n(f, [t], e, 2, r),
                        t === "createImageData" || t === "createPattern"
                          ? ((s = `${t}()`),
                  ...
                  e[t],
          set: (e, t, n) => (
            typeof t == "string" && t in p ?
                  (p[t] !== n && typeof n != "function" && s(f, [t], n),
                (p[t] = n)) :
                  (e[t] = n),
            !0
          ),
    ...
    const g = (e, t, r) => {
      const i = e[o];
            const c = a();
            const h = { [o]: i, [d]: c, [u]: [] };
            const f = n(e, ["getContext"], [t, r], 1, c);
            const p = {
          get: (e, t) =>
            "string" === typeof t ?
                  "function" !== typeof f[t] ?
          ...
          set: (e, t, n) => (
            "string" === typeof t && t in f ?
                  (f[t] !== n && typeof n != "function" && s(h, [t], n),
                (f[t] = n)) :
                  (e[t] = n),
            !0
          ),
    ...
    const l = "checkFramebufferStatus,makeXRCompatible".split(",");
    const m = (e) =>
      e.startsWith("create") ||
      e.startsWith("get") ||
      e.startsWith("is") ||
